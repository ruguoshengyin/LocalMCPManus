 ...
 */
// 导出一个名为HumanRelayDialog的React函数组件，接受HumanRelayDialogProps类型的参数
export const HumanRelayDialog: React.FC<HumanRelayDialogProps> = ({
	...
	// 使用useAppTranslation获取翻译函数t
	const { t } = useAppTranslation()
	// 使用useState定义一个名为response的状态变量，初始值为空字符串
	const [response, setResponse] = React.useState("")
	// 使用useClipboard获取复制到剪贴板的方法copy
