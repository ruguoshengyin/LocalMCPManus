...
function ToolCard({ tool, onSettings, onRun, onClone }) {
  return (
    <div className="bg-white dark:bg-gray-700 rounded-lg shadow overflow-hidden hover:shadow-md transition-shadow duration-300">
      <div className="p-4">
        <div className="flex items-center">
          <div className="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-lg bg-indigo-100 dark:bg-indigo-900 text-xl">
            {tool.icon}
          </div>
          <div className="ml-4 flex-1">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">{tool.title}</h3>
            <p className="text-sm text-gray-500 dark:text-gray-300 line-clamp-2">{tool.description}</p>
          </div>
        </div>
